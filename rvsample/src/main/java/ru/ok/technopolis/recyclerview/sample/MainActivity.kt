...
class MainActivity : AppCompatActivity(), MoviesAdapter.Listener {
    ...
    private fun generateMovieList(): MutableList<Movie> {
        val movies: MutableList<Movie> = ArrayList()
        movies.add(Movie("Побег из Шоушенка",
        ...
        movies.add(Movie("Матрица",
                ...
                R.drawable.movie_2))
        movies.add(Movie("Как приручить дракона",
        ...
        movies.add(Movie("12 стульев",
                ...
                R.drawable.movie_4))
        movies.add(Movie("Зеленая книга",
                ...
                R.drawable.movie_5))
        movies.add(Movie("Пираты Карибского моря: Проклятие Черной жемчужины",
                ...
                R.drawable.movie_6))
        movies.add(Movie("Гарри Поттер и философский камень",
